...
public class GoogleDriveRestSharingCode extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_google_drive_rest_sharing_code);

        this.setTitle("Code de partage");

        mIndication = (TextView) findViewById(R.id.SharingOutputTextView);
        mOutputText = (TextView) findViewById(R.id.SharingCodeTextView);
        mInformation = (TextView) findViewById(R.id.SharingInformationTextView);


        mOutputText.setText("Calling Drive API ...");
    ...
    void showGooglePlayServicesAvailabilityErrorDialog(
        ...
        Dialog dialog = GooglePlayServicesUtil.getErrorDialog(
                ...
                GoogleDriveRestSharingCode.this,
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            GoogleDriveRestSharingCode.REQUEST_AUTHORIZATION);
                } else {
